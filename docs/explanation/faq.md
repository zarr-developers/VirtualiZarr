...
| From a netCDF3 file                                                      | `kerchunk.netCDF3.NetCDF3ToZarr`                                                                                                    | `open_virtual_dataset(..., parser=NetCDF3Parser())` (reads the header directly; also supports CDF-5, which kerchunk/scipy cannot)                                                                                     |
