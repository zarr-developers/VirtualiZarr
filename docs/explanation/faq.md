...
| From a netCDF3 file                                                      | `kerchunk.netCDF3.NetCDF3ToZarr`                                                                                                    | `open_virtual_dataset(..., parser=NetCDF3Parser())` (also supports [CDF-5](https://docs.unidata.ucar.edu/nug/current/netcdf_introduction.html#:~:text=CDF%2D2%20files.-,NetCDF%2064%2Dbit%20Data%20Format%20(CDF%2D5),-To%20allow%20large), which kerchunk/scipy do not)                                                                                     |
