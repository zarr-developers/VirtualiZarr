...
!!! note
    ...
    Nevertheless this approach is used by VirtualiZarr internally, at least for the netCDF3, HDF4, and the (since-deprecated-and-removed original implementation of the) HDF5 file format parsers.
