...
You now must pass in a valid [Parser][virtualizarr.parsers.typing.Parser] and a [obspec_utils.registry.ObjectStoreRegistry][] to [virtualizarr.open_virtual_dataset][].
