...
| From a Zarr v3 store                                                     | n/a                                                                                                          | `open_virtual_dataset` (❌ Not yet implemented - see [issue #262](https://github.com/zarr-developers/VirtualiZarr/issues/262))                                                                                       |
...
| From a [DMR++](https://opendap.github.io/DMRpp-wiki/DMRpp.html) metadata file                                                    | n/a                                                                                                        | `open_virtual_dataset`, via `virtualizarr.readers.dmrpp.DMRParser`                                                                                      |
